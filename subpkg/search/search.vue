<template>
  <view>
    ...
    <view class="history-box" v-else>
      ...
      <!-- 列表区域 -->
      <view class="history-list" padding>
        <uni-tag :circle="true"  :text="item" v-for="(item, i) in histories" :key="i" @click="gotoGoodsList(item)"></uni-tag>
      </view>
    </view>
  </view>
